...
scale_bar <- function(lon, lat, distance_lon, distance_lat, distance_legend, dist_unit = "km", rec_fill = "white", rec_colour = "black", rec2_fill = "black", rec2_colour = "black", legend_colour = "white", legend_size = 2.5, orientation = TRUE, arrow_length = 500, arrow_distance = 300, arrow_north_size = 6){
